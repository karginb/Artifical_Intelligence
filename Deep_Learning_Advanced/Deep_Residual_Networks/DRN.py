...
#%%
# read train negative
train_negative_path = "Deep Residual Networks\LSIFIR\Classification\Train\neg"
...
# read train positive
train_positive_path = "Deep Residual Networks\LSIFIR\Classification\Train\pos"
...
print("x_train_positive_tensor:",x_train_positive_tensor)

y_train_positive_tensor = torch.ones(num_train_positive_img,dtype = torch.long())
print("y_train_positive_tensor:",y_train_positive_tensor)
...
# read test negative
test_negative_path = "Deep Residual Networks\LSIFIR\Classification\Test\neg"
...
# read test positive
test_positive_path = "Deep Residual Networks\LSIFIR\Classification\Test\pos"
...
#%%
plt.imshow(x_train[40001,:].reshape(64,32),cmap = "gray")
#%%CNN
# Hyperparameter
num_epochs = 5000
num_classes = 2
...
trainLoader = torch.utils.DataLoader(train,batch_size = batch_size,shuffle = True)

test = torch.utils.data.TensorDataset(x_test,y_test)
testLoader = torch.utils.DataLoader(test,batch_size = batch_size,shuffle = False)
